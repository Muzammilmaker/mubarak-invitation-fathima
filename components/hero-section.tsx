    ...
    <div className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl">
        ...
        <div className="mb-8 animate-fade-up elegant-fade" style={{ animationDelay: '0.1s' }}>
          <p className="text-2xl md:text-3xl text-gold font-light mb-2 drop-shadow-lg">
        ...
        <div className="mb-6 animate-fade-up elegant-fade" style={{ animationDelay: '0.2s' }}>
          <p className="text-xs md:text-sm text-gold tracking-widest uppercase font-light">
        ...
        <div className="mb-8 animate-fade-up elegant-fade" style={{ animationDelay: '0.3s' }}>
          <p className="text-cream font-heading text-lg md:text-xl font-light mb-8">
        ...
        <div className="mt-12 animate-fade-up elegant-fade" style={{ animationDelay: '0.5s' }}>
          <button
            ...
            className="px-8 py-3 border-2 border-gold text-gold hover:bg-gold/10 transition-all duration-300 font-body font-medium tracking-wide uppercase text-sm rounded-lg hover:shadow-[0_0_20px_rgba(212,175,55,0.3)]"
          >
            View Invitation
          </button>
        </div>
