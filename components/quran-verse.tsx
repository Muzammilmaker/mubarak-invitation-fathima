      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="border-2 border-gold/50 rounded-lg p-8 md:p-12 bg-emerald-900/30 backdrop-blur-sm">
          ...
          <div className="text-center mb-8">
            <p className="font-heading text-xl md:text-2xl text-gold leading-relaxed mb-4 rtl">
          ...
          <div className="text-center">
            ...
            <p className="text-gold font-heading text-sm font-light tracking-wide uppercase">
              Quran 30:21
            </p>
          </div>
        </div>
