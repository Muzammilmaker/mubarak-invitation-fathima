      ...
      <div className="max-w-3xl w-full">
        ...
        <div className="border-4 border-gold/50 rounded-lg p-8 md:p-16 bg-emerald-900/40 backdrop-blur-sm">
          ...
          <div className="text-center mb-8">
            <p className="font-heading text-2xl md:text-3xl text-gold leading-relaxed rtl mb-4">
          ...
          <div className="text-center mb-8 pb-8 border-b-2 border-gold/30">
            <p className="text-cream/90 font-body text-base md:text-lg italic leading-relaxed">
          ...
          <div className="text-center">
            <p className="text-cream/80 font-body text-sm md:text-base leading-relaxed mb-6">
            ...
            <p className="text-gold font-heading text-lg font-light">
              Jazak Allah Khair
            </p>
